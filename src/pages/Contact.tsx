...
const Contact: React.FC = () => {
  ...
  useEffect(() => { (async () => setDoc(await loadPage('contact')))(); }, []);
    ...
    return (
      <div className="min-h-screen bg-stone-50">
        <section className="max-w-5xl mx-auto px-6 py-12">
          <h1 className="text-4xl font-bold text-stone-900">{frontmatter.title || 'Contact'}</h1>
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <section className="max-w-5xl mx-auto px-6 py-12">
        ...
        <p className="text-stone-600">CMS content not found yet. Add contact.md in Pages CMS.</p>
      </section>
    </div>
  );
};
