...
const {
  researchAreas,
  currentResearchProjects, // Renamed from currentProjects in JSON for clarity
  methodologies,
  // appliedProjects list is now generated by filtering the main 'projects' list
  projects
} = projectsData;
// ======================================================
...
const Research = () => {
  ...
  // NOTE: The hardcoded arrays are now replaced by imported variables.

  // Re-define appliedProjects and categories based on the imported master 'projects' list
  const appliedProjects = projects.filter(p => p.category === 'academic' || p.category === 'advocacy' || p.category === 'community' || p.category === 'research').slice(0, 4); 
  ...
  return (
    <div className="pt-16">
      ...
      {/* Research Areas - EDITED: Uses imported researchAreas */}
      ...
      {/* Current Projects - EDITED: Uses imported currentResearchProjects */}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Note: Philosophy is still mostly hardcoded text, but could be moved to JSON for full CM */}
            <div className="text-center">
      ...
      {/* Applied Projects - EDITED: Uses local appliedProjects derived from imported projects */}
      <section className="py-20 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-4">
          ...
          {/* Filter Buttons - EDITED: Uses derived projectCategories */}
      ...
      {/* Methodologies - EDITED: Uses imported methodologies */}
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-stone-900 mb-4">
